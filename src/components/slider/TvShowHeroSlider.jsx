...
const img1 = `${import.meta.env.VITE_APP_IMAGE_PATH}images/tv-show/banner-1.webp`;
const img2 = `${import.meta.env.VITE_APP_IMAGE_PATH}images/tv-show/banner-2.webp`;
const img3 = `${import.meta.env.VITE_APP_IMAGE_PATH}images/tv-show/banner-3.webp`;
