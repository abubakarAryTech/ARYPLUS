...
const ProductDetailCard = memo((props) => {
  const product = [
    {
      id: "01",
      thumbnail: `${import.meta.env.VITE_APP_IMAGE_PATH}images/shop/product/01.webp`,
    },
    {
      id: "02",
      thumbnail: `${import.meta.env.VITE_APP_IMAGE_PATH}images/shop/product/02.webp`,
    },
    {
      id: "03",
      thumbnail: `${import.meta.env.VITE_APP_IMAGE_PATH}images/shop/product/03.webp`,
    },
    {
      id: "04",
      thumbnail: `${import.meta.env.VITE_APP_IMAGE_PATH}images/shop/product/04.webp`,
    },
    {
      id: "05",
      thumbnail: `${import.meta.env.VITE_APP_IMAGE_PATH}images/shop/product/02.webp`,
                        ...
                        <li className="pb-5 mb-5 border-bottom">
                          <div className="d-flex flex-sm-row flex-column align-items-sm-center align-items-start gap-4">
                            <div className="user-image flex-shrink-0">
                              <img
                                src={`${import.meta.env.VITE_APP_IMAGE_PATH}images/shop/avatar.webp`}
                                alt=""
                              />
                            </div>
