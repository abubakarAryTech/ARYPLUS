                ...
                <div className="footer-inner">
                  ...
                  <div className="mt-5">
                    ...
                    <ul className="list-inline d-flex align-items-center flex-wrap gap-3 m-0">
                      <li>
                        <img src={`${import.meta.env.VITE_APP_IMAGE_PATH}images/footer/01.webp`} alt="visa" />
                      </li>
                      <li>
                        <img src={`${import.meta.env.VITE_APP_IMAGE_PATH}images/footer/02.webp`} alt="visa" />
                      </li>
                      <li>
                        <img src={`${import.meta.env.VITE_APP_IMAGE_PATH}images/footer/03.webp`} alt="visa" />
                      </li>
                      <li>
                        <img src={`${import.meta.env.VITE_APP_IMAGE_PATH}images/footer/04.webp`} alt="visa" />
                      </li>
                    </ul>
                  </div>
                </div>
            ...
            <Row className="align-items-center">
              <Col md="6" className="text-md-start text-center">
                <p className="m-0 font-size-14 text-capitalize">
                  ...
                  <Link to="/"> STREAMIT </Link> All rights reserved.
                </p>
              </Col>
