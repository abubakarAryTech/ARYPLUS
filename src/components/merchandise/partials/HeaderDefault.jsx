          ...
          <div className="header-top d-xl-block d-none">
            <Container fluid>
              <Row className="align-items-center">
                ...
                <Col md="9">
                  <div className="navbar-right menu-right text-left">
                    <ul className="d-flex align-items-center justify-content-end gap-3 list-inline mb-0 ">
                      ...
                      <Dropdown as="li" className="nav-item nav-icon me-0">
                        ...
                        <Dropdown.Menu
                          as="ul"
                          className="dropdown-menu-end border-0 p-0 m-0 show"
                        >
                          <li className="user-info d-flex align-items-center gap-3 mb-3 me-0">
                            <img
                              src={`${import.meta.env.VITE_APP_IMAGE_PATH}images/user/user1.webp`}
                              alt="user"
                              loading="lazy"
                              className="img-fluid"
                            />
                      ...
                      >
                        <Nav.Item as="li">
                          <Nav.Link
                            ...
                            className={`${location.pathname === "/merchandise-store" || location.pathname === "/" || location.pathname === "/home" || location.pathname === "/movies" || location.pathname === "/tv-shows" || location.pathname === "/videos" ? "active" : ""}`}
                          >
                            ...
                            <ul>
                              ...
                              <Nav.Item as="li">
                                <Link
                                  ...
                                  className={`${location.pathname === "/merchandise-store" ? "active" : ""} nav-link`}
                                >
                                  {" "}
                                  Merchandise Store{" "}
                                </Link>
                            ...
                            <ul>
                              <Nav.Item as="li">
                                <Link
                                  ...
                                  className={`${location.pathname === "/restricted-content" ? "active" : ""} nav-link`}
                                >
                                  {" "}
                                  Restricted Content{" "}
                                </Link>
                              ...
                              <Nav.Item as="li">
                                <Link
                                  ...
                                  className={`${location.pathname === "/related-merchandise" ? "active" : ""} nav-link`}
                                >
                                  {" "}
                                  Related Merchandise{" "}
                                </Link>
                              ...
                              <Nav.Item as="li">
                                <Link
                                  to="/playlist"
                                  className={`${location.pathname === "/playlist" ? "active" : ""} nav-link`}
                                >
                                  {" "}
                                  Playlist{" "}
                                </Link>
                              ...
                              <Nav.Item as="li">
                                <Link
                                  to="/geners"
                                  className={`${location.pathname === "/geners" ? "active" : ""} nav-link`}
                                >
                                  {" "}
                                  Genres{" "}
                                </Link>
                        ...
                        <Nav.Item as="li">
                          <Nav.Link
                            ...
                            className={`${location.pathname === "/about-us" || location.pathname === "/contact-us" || location.pathname === "/fa1" || location.pathname === "/PrivacyPolicy" || location.path === "/pricing" || location.pathname === "/coming-soon" ? "active" : ""}`}
                          >
                            ...
                            <ul>
                              ...
                              <Nav.Item as="li">
                                <Nav.Link
                                  ...
                                  className={`${location.pathname === "/blogs/single" || location.pathname === "/blogs/double" || location.pathname === "/blogs/large-grid" || location.pathname === "/blogs/small-grid" ? "active" : ""}`}
                                >
                                ...
                                >
                                  <ul>
                                    <Nav.Item as="li">
                                      <Link
                                        to="/blogs/single"
                                        className={`${location.pathname === "/blogs/single" ? "active" : ""} nav-link`}
                                      >
                                        {" "}
                                        1 Column{" "}
                                      </Link>
                                    ...
                                    <Nav.Item as="li">
                                      <Link
                                        to="/blogs/double"
                                        className={`${location.pathname === "/blogs/double" ? "active" : ""} nav-link`}
                                      >
                                        {" "}
                                        2 column
                                      </Link>
                                    ...
                                    <Nav.Item as="li">
                                      <Link
                                        to="/blogs/large-grid"
                                        className={`${location.pathname === "/blogs/large-grid" ? "active" : ""} nav-link`}
                                      >
                                        {" "}
                                        3 column{" "}
                                      </Link>
                                    ...
                                    <Nav.Item as="li">
                                      <Link
                                        to="/blogs/small-grid"
                                        className={`${location.pathname === "/blogs/small-grid" ? "active" : ""} nav-link`}
                                      >
                                        {" "}
                                        4 column{" "}
                                      </Link>
                                  ...
                                  <ul>
                                    <Nav.Item as="li">
                                      <Link
                                        ...
                                        className={`${location.pathname === "/blog-template/everything-you-need-to-know-about" ? "active" : ""} nav-link`}
                                      >
                                        {" "}
                                        Blog Template{" "}
                                      </Link>
                                    ...
                                    <Nav.Item as="li">
                                      <Link
                                        ...
                                        className={`${location.pathname === "/blogs-detail/the-most-anticipated-movies" ? "active" : ""} nav-link`}
                                      >
                                        {" "}
                                        Standard{" "}
                                      </Link>
                                    ...
                                    <Nav.Item as="li">
                                      <Link
                                        ...
                                        className={`${location.pathname === "/blog-single/audio" ? "active" : ""} nav-link`}
                                      >
                                        {" "}
                                        Audio{" "}
                                      </Link>
                                    ...
                                    <Nav.Item as="li">
                                      <Link
                                        ...
                                        className={`${location.pathname === "/blog-single/video" ? "active" : ""} nav-link`}
                                      >
                                        {" "}
                                        Video{" "}
                                      </Link>
                                    ...
                                    <Nav.Item as="li">
                                      <Link
                                        to="/blog-single/link"
                                        className={`${location.pathname === "/blog-single/link" ? "active" : ""} nav-link`}
                                      >
                                        {" "}
                                        Link{" "}
                                      </Link>
                                    ...
                                    <Nav.Item as="li">
                                      <Link
                                        ...
                                        className={`${location.pathname === "/blog-single/quote" ? "active" : ""} nav-link`}
                                      >
                                        {" "}
                                        Quote{" "}
                                      </Link>
                                    ...
                                    <Nav.Item as="li">
                                      <Link
                                        ...
                                        className={`${location.pathname === "/blog-single/gallery" ? "active" : ""} nav-link`}
                                      >
                                        {" "}
                                        Gallery{" "}
                                      </Link>
                        ...
                        <Nav.Item as="li">
                          <Nav.Link
                            ...
                            className={`${location.pathname === "/shop" || location.pathname === "/account" || location.pathname === "/cart" || location.pathname === "/wishlist" || location.pathname === "/checkout" || location.pathname === "/track-order" ? "active" : ""}`}
                          >
                          ...
                          >
                            <ul>
                              <Nav.Item as="li">
                                <Link
                                  to="/shop"
                                  className={`${location.pathname === "/shop" ? "active" : ""} nav-link`}
                                >
                                  {" "}
                                  Shop{" "}
                                </Link>
                              ...
                              <Nav.Item as="li">
                                <Link
                                  to="/account"
                                  className={`${location.pathname === "/account" ? "active" : ""} nav-link`}
                                >
                                  {" "}
                                  My Account Page{" "}
                                </Link>
                              ...
                              <Nav.Item as="li">
                                <Link
                                  to="/wishlist"
                                  className={`${location.pathname === "/wishlist" ? "active" : ""} nav-link`}
                                >
                                  {" "}
                                  Wishlist Page{" "}
                                </Link>
                              ...
                              <Nav.Item as="li">
                                <Link
                                  to="/checkout"
                                  className={`${location.pathname === "/checkout" ? "active" : ""} nav-link`}
                                >
                                  {" "}
                                  Checkout Page{" "}
                                </Link>
                              ...
                              <Nav.Item as="li">
                                <Link
                                  to="/track-order"
                                  className={`${location.pathname === "/track-order" ? "active" : ""} nav-link`}
                                >
                                  {" "}
                                  Order Tracking{" "}
                                </Link>
