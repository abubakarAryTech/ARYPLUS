...
const MovieSlider = ({ focusMode, onFocusChange, sectionName = "DRAMAS", title = "Featured Movies", sectionId }) => {
  ...
  return (
    <section className="top10-container">
      ...
      <div className="top10-slider">
        ...
        <div className="movie-slider-list" style={{ transform: `translateX(-${currentIndex * 340}px)`, paddingLeft: '60px' }}>
