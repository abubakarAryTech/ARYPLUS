export const blogsDetails = [
  ...
  },
  {
    ...
    <img src=${import.meta.env.VITE_APP_IMAGE_PATH}images/blog/audio.webp" className="img-fluid mb-5" alt="01">
  ...
  },
  {
    ...
    <li className="col mb-4">
      <a data-fslightbox="gallery" href=${import.meta.env.VITE_APP_IMAGE_PATH}images/blog/1.webp">
        <img className="img-fluid" src=${import.meta.env.VITE_APP_IMAGE_PATH}images/blog/1.webp" alt="blog-gallery" />
      </a>
    </li>
    <li className="col mb-4">
      <a data-fslightbox="gallery" href=${import.meta.env.VITE_APP_IMAGE_PATH}images/blog/2.webp">
        <img className="img-fluid" src=${import.meta.env.VITE_APP_IMAGE_PATH}images/blog/2.webp" alt="blog-gallery" />
      </a>
    </li>
    <li className="col mb-4">
      <a data-fslightbox="gallery" href=${import.meta.env.VITE_APP_IMAGE_PATH}images/blog/3.webp">
        <img className="img-fluid" src=${import.meta.env.VITE_APP_IMAGE_PATH}images/blog/3.webp" alt="blog-gallery" />
      </a>
    </li>
    <li className="col mb-4">
      <a data-fslightbox="gallery" href=${import.meta.env.VITE_APP_IMAGE_PATH}images/blog/4.webp">
        <img className="img-fluid" src=${import.meta.env.VITE_APP_IMAGE_PATH}images/blog/4.webp" alt="blog-gallery" />
      </a>
    </li>
    <li className="col mb-4">
      <a data-fslightbox="gallery" href=${import.meta.env.VITE_APP_IMAGE_PATH}images/blog/5.webp">
        <img className="img-fluid" src=${import.meta.env.VITE_APP_IMAGE_PATH}images/blog/5.webp" alt="blog-gallery" />
      </a>
    </li>
    <li className="col mb-4">
      <a data-fslightbox="gallery" href=${import.meta.env.VITE_APP_IMAGE_PATH}images/blog/Fantacy.webp">
        <img className="img-fluid" src=${import.meta.env.VITE_APP_IMAGE_PATH}images/blog/Fantacy.webp" alt="blog-gallery" />
      </a>
    </li>
  </ul>
  <div className="blog-single-icon mt-0">
