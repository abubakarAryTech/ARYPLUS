export const generateImgPath = (path) => {
  // Remove /assets/ prefix if present since images are now served from CDN
  const cleanPath = path.startsWith('/assets/') ? path.replace('/assets/', '') : path;
  return import.meta.env.VITE_APP_IMAGE_PATH + cleanPath;
};
