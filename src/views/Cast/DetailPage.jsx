...
const DetailPage = memo(() => {
  const cast = {
    id: "01",
    thumbnail: `${import.meta.env.VITE_APP_IMAGE_PATH}images/cast/01.webp`,
    name: "Debbi Bossi",
    ...
    works: [
      {
        ...
        name: "Mortal Norris",
        as: "Christina Ricci",
        thumbnail: `${import.meta.env.VITE_APP_IMAGE_PATH}images/movies/latest/01.webp`,
        year: "2009",
      },
      {
        id: "2",
        name: "Advetre",
        as: "Christina Ricci",
        thumbnail: `${import.meta.env.VITE_APP_IMAGE_PATH}images/movies/latest/02.webp`,
        year: "2009",
      },
      {
        id: "3",
        name: "Net Ailo",
        as: "Christina Ricci",
        thumbnail: `${import.meta.env.VITE_APP_IMAGE_PATH}images/movies/latest/03.webp`,
        year: "2009",
      },
      {
        id: "4",
        ...
        thumbnail: `${import.meta.env.VITE_APP_IMAGE_PATH}images/movies/latest/04.webp`,
        year: "2009",
      },
    ],
    most_views: [
      {
        id: "01",
        thumbnail: `${import.meta.env.VITE_APP_IMAGE_PATH}images/movies/popular/01.webp`,
        title: "CRW",
        duration: "2hr: 12mins",
      ...
      {
        id: "02",
        thumbnail: `${import.meta.env.VITE_APP_IMAGE_PATH}images/movies/popular/03.webp`,
        title: "Goal",
        duration: "2hr: 30mins",
        watchlistLink: "/playlist",
        link: "/movies-detail",
      ...
      {
        id: "03",
        thumbnail: `${import.meta.env.VITE_APP_IMAGE_PATH}images/movies/popular/04.webp`,
        title: "Dandacg",
        duration: "1hr: 30mins",
        watchlistLink: "/playlist",
        link: "/movies-detail",
      ...
      {
        id: "04",
        thumbnail: `${import.meta.env.VITE_APP_IMAGE_PATH}images/movies/popular/05.webp`,
        title: "Mexcan",
        duration: "1hr: 30mins",
        watchlistLink: "/playlist",
        link: "/movies-detail",
            ...
            <Col lg="9" md="7">
              ...
              <div className="seperator d-flex align-items-center flex-wrap mb-3">
                {cast.roles.map((item, index) => {
                  return (
                    <>
                      <span className="fw-semibold text-capitalize" key={index}>
                        {item}
                      </span>
