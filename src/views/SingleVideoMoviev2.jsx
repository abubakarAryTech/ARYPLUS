...
const SingleVideoMoviev2 = memo(({ user, isAuthenticated }) => {
  useEnterExit();
...
const SingleVideoMoviev2WithAuth = () => {
  const { user, isAuthenticated } = useAuthStore();
  return <SingleVideoMoviev2 user={user} isAuthenticated={isAuthenticated} />;
};

SingleVideoMoviev2.displayName = "SingleVideoMoviev2";
export default SingleVideoMoviev2WithAuth;
