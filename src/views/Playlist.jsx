...
const Playlist = memo(() => {
  ...
  const playlist = [
    {
      image: `${import.meta.env.VITE_APP_IMAGE_PATH}images/movies/playlist/01.webp`,
      title: "Play List 1",
      category: "Public",
      views: "3 Views",
    },
    {
      image: `${import.meta.env.VITE_APP_IMAGE_PATH}images/movies/playlist/02.webp`,
      title: "Play List 2",
      category: "Private",
      views: "1 Views",
    },
    {
      image: `${import.meta.env.VITE_APP_IMAGE_PATH}images/movies/playlist/03.webp`,
      title: "Play List 3",
      category: "Public",
      views: "10 Views",
    },
    {
      image: `${import.meta.env.VITE_APP_IMAGE_PATH}images/movies/playlist/04.webp`,
      title: "Play List 4",
      category: "Public",
      views: "30 Views",
    },
    {
      image: `${import.meta.env.VITE_APP_IMAGE_PATH}images/movies/playlist/05.webp`,
      title: "Play List 5",
      category: "Private",
      views: "2 Views",
    },
    {
      image: `${import.meta.env.VITE_APP_IMAGE_PATH}images/movies/playlist/06.webp`,
      title: "Play List 6",
      category: "Public",
      views: "10 Views",
    },
    {
      image: `${import.meta.env.VITE_APP_IMAGE_PATH}images/movies/playlist/07.webp`,
      title: "Play List 7",
      category: "Public",
      views: "50 Views",
    },
            ...
            <div className="d-flex flex-wrap align-items-center justify-content-between gap-2">
              <div className="d-flex align-items-center gap-3">
                <div className="account-logo d-flex align-items-center position-relative">
                  <img
                    src={`${import.meta.env.VITE_APP_IMAGE_PATH}images/pages/profile.webp`}
                    alt="profile"
