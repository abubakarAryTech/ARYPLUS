                ...
                <Row className="h-100 align-items-center text-center mt-5">
                  ...
                  >
                    ...
                    <div className="my-4">
                      ...
                      >
                        We're currently performing maintenance or experiencing a temporary issue with our servers.
                      </p>
                      <p
                        className="mt-2"
                        style={{
                      ...
                      >
                        Rest assured, we're working hard to resolve the issue and restore full service as quickly as possible.
                      </p>
                      <p
                        className="mt-3"
                        style={{
