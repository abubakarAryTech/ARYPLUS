...
// img
const img1 = `${import.meta.env.VITE_APP_IMAGE_PATH}images/shop/product/01.webp`;
const img2 = `${import.meta.env.VITE_APP_IMAGE_PATH}images/shop/product/02.webp`;
const img3 = `${import.meta.env.VITE_APP_IMAGE_PATH}images/shop/product/03.webp`;
