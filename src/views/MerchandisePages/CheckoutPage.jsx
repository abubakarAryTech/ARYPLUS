...
// img
const img4 = `${import.meta.env.VITE_APP_IMAGE_PATH}images/shop/product/zap.png`;
...
const CheckoutPage = memo(() => {
  ...
  const { subscriptionID, subscriptionName, stripePriceID, subscriptionPrice } =
    useParams();
              ...
              <div className="order_review-box border p-4">
                ...
                <div className="checkout-review-order">
                  ...
                  <div className="checkout-payment mt-4 pt-3 pb-2">
                            ...
                            >
                              <span className="form-check">
                                <input
                                  onClick={() =>
                                    changePayment(
                                      `https://payment.aryzap.com?customer_id=${user.uid}&package_id=${subscriptionID}`,
                                    )
                                  }
                                  className="form-check-input"
                                  type="radio"
                    ...
                    {pLink === "stripe" ? (
                      <form
                        action="https://payment.aryzap.com/create-checkout-session"
                        method="POST"
                      >
                        <input
                          type="text"
