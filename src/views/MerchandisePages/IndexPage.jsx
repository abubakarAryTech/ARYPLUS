...
// img
const img1 = `${import.meta.env.VITE_APP_IMAGE_PATH}images/shop/card/capton-america.webp`;
const img2 = `${import.meta.env.VITE_APP_IMAGE_PATH}images/shop/card/deadpool.webp`;
const img3 = `${import.meta.env.VITE_APP_IMAGE_PATH}images/shop/card/multipal.webp`;
const location = `${import.meta.env.VITE_APP_IMAGE_PATH}images/shop/card/location.webp`;
